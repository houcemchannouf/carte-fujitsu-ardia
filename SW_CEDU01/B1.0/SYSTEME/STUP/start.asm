...
; 3  History
;====================================================================
; Id: START.ASM 4041 2009-10-29 08:40:57Z rlande 

#define VERSION  "1.59"
/*
Revision 1.59 4041 2009-10-29 08:40:57Z rlande 
- changed: configuration sequence of CSs for external vector mode.

Revision 1.58 Id: START.ASM 3798 2009-09-29 08:46:42Z rlande
...
#set      CLOCK_SPEED     CPU_8MHZ_CLKP2_8MHZ  ; <<< set clock speeds
...
#set      BDM_CONFIGURATION  B'0000000000010010  ; <<< set BDM configuration
;                                    ||||||||++--- BdmUART
;                                    ||||||||      (0: A, 1: B, 2: C, 3: D)
;                                    ||||||++----- BdmSynchMode
;                                    ||||||        (0: Async., 1: Sync.

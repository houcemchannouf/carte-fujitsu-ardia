...
/* NOTE:                                                                     */
/*                                                                           */
/* This header-file covers all features of the chip MB96F346RS.              */
/*                                                                           */
/*                                                                           */
/* ----------------------------------------------------------------------    */
/* History:                                                                  */
/*                                                                           */
/* V1.9  2009-08-31 13:45:31 +0200 (Mon, 31 Aug 2009) rlande           3724  */
/* - removed: Dollar characters from versioning tag.                         */ 
/* - removed: Bit definitions from ADSR.                                     */ 
/* - renamed: VRCR_LPBM to VRCR_LPMB.                                        */ 
/*                                                                           */ 
/* V1.8  2008-09-12 10:31:35 +0200 (Fri, 12 Sep 2008) rlande           2392  */
/* - changed: PDR10, DDR10, PIER10, PILR10, EPILR10, PODR10, PUCR10, EPSR10, */
/*            ADECR, DSR, DSSR, DER                                          */
/* - removed: FMWC2, FMWC3, FMWC4                                            */
/*                                                                           */
/* V1.7  2008-02-27 09:33:03 +0100 (Wed, 27 Feb 2008)  mwilla          1971  */
/* - Flash control registers changed (Flash A/B)                             */
/*                                                                           */
/* V1.6  2007-09-20 16:30:25 +0200 (Thu, 20 Sep 2007)  mwilla          1963  */
/* - Completely revised version                                              */
/*                                                                           */
/* V1.5  2007-05-04 16:22:04 +0200 (Fri, 04 May 2007)  meffen          1952  */
/* - added LIN USART 7,8,9                                                   */
/*                                                                           */
/* V1.4  2007-04-12 16:17:12 +0200 (Thu, 12 Apr 2007)  meffen          1943  */
/* - added Voltage Regulator Control Register                                */
/* - added RD19V bit in Flash Memory Control Status Register                 */
/*                                                                           */
/* V1.3  2007-02-09 10:28:57 +0100 (Fri, 09 Feb 2007)  phuene          1930  */
/* - correct addresses of LIN-UART3 registers                                */
/* - allow only 16 bit access for the ADSR                                   */
/*                                                                           */
/* V1.1  2007-01-17 09:31:26 +0100 (Wed, 17 Jan 2007)  phuene          1928  */
/* - add 32-bit access names for CAN controllers, where applicable           */
/*                                                                           */
/* V1.0  2006-12-27 10:25:00 +0100 (Wed, 27 Dec 2006)  phuene          1925  */
/* - initial version                                                         */
/*                                                                           */
...
#  endif
#  define __IO_BASE     __IO_EXTERN __io
#  define __IO_EXTENDED __IO_EXTERN volatile ___IOWIDTH
#  define __IO_FAR      __IO_EXTERN volatile __far
...
__IO_BASE IO_WORD _tmrlr0;
#define TMRLR0 _tmrlr0   
__IO_BASE IO_WORD _tmr0;
#define TMR0 _tmr0   
__IO_BASE TMCSR1STR _tmcsr1;  
...
__IO_BASE IO_WORD _tmrlr1;
#define TMRLR1 _tmrlr1   
__IO_BASE IO_WORD _tmr1;
#define TMR1 _tmr1   
__IO_BASE TMCSR2STR _tmcsr2;  
...
__IO_BASE IO_WORD _tmrlr2;
#define TMRLR2 _tmrlr2   
__IO_BASE IO_WORD _tmr2;
#define TMR2 _tmr2   
__IO_BASE TMCSR3STR _tmcsr3;  
...
__IO_BASE IO_WORD _tmrlr3;
#define TMRLR3 _tmrlr3   
__IO_BASE IO_WORD _tmr3;
#define TMR3 _tmr3   
__IO_BASE TMCSR6STR _tmcsr6;  
...
__IO_BASE IO_WORD _tmrlr6;
#define TMRLR6 _tmrlr6   
__IO_BASE IO_WORD _tmr6;
#define TMR6 _tmr6   
__IO_BASE GCN10STR _gcn10;  
...
__IO_BASE IO_BYTE _tdr0;
#define TDR0 _tdr0   
__IO_BASE IO_BYTE _rdr0;
#define RDR0 _rdr0   
__IO_BASE SSR0STR _ssr0;  
...
__IO_BASE IO_BYTE _tdr1;
#define TDR1 _tdr1   
__IO_BASE IO_BYTE _rdr1;
#define RDR1 _rdr1   
__IO_BASE SSR1STR _ssr1;  
...
__IO_BASE IO_BYTE _tdr2;
#define TDR2 _tdr2   
__IO_BASE IO_BYTE _rdr2;
#define RDR2 _rdr2   
__IO_BASE SSR2STR _ssr2;  
...
__IO_BASE IO_BYTE _tdr3;
#define TDR3 _tdr3   
__IO_BASE IO_BYTE _rdr3;
#define RDR3 _rdr3   
__IO_BASE SSR3STR _ssr3;  
...
__IO_EXTENDED EDSU2LSTR _edsu2l;  
#define EDSU2L _edsu2l.byte
#define EDSU2L_RSEL0 _edsu2l.bit._RSEL0
#define EDSU2L_RSEL1 _edsu2l.bit._RSEL1
#define EDSU2L_RSEL2 _edsu2l.bit._RSEL2
#define EDSU2L_RSEL3 _edsu2l.bit._RSEL3
#define EDSU2L_RSEL4 _edsu2l.bit._RSEL4
#define EDSU2L_RSEL5 _edsu2l.bit._RSEL5
#define EDSU2L_RSEL6 _edsu2l.bit._RSEL6
#define EDSU2L_RSEL7 _edsu2l.bit._RSEL7
#define EDSU2L_RSEL _edsu2l.bitc._RSEL
__IO_EXTENDED EDSU2HSTR _edsu2h;  
#define EDSU2H _edsu2h.byte
#define EDSU2H_TSEL0 _edsu2h.bit._TSEL0
#define EDSU2H_TSEL1 _edsu2h.bit._TSEL1
#define EDSU2H_TSEL2 _edsu2h.bit._TSEL2
#define EDSU2H_TSEL3 _edsu2h.bit._TSEL3
#define EDSU2H_TSEL4 _edsu2h.bit._TSEL4
#define EDSU2H_TSEL5 _edsu2h.bit._TSEL5
#define EDSU2H_TSEL6 _edsu2h.bit._TSEL6
#define EDSU2H_TSEL7 _edsu2h.bit._TSEL7
#define EDSU2H_TSEL _edsu2h.bitc._TSEL
...
#define SMCR_LPMS _smcr.bit._LPMS
#define SMCR_LPMSS _smcr.bit._LPMSS
#define SMCR_LPMBSS _smcr.bit._LPMBSS
...
#define VRCR_LPMB0 _vrcr.bit._LPMB0
#define VRCR_LPMB1 _vrcr.bit._LPMB1
...
#define VRCR_LPMB _vrcr.bitc._LPMB
#define VRCR_LPMA _vrcr.bitc._LPMA
#define VRCR_HPM _vrcr.bitc._HPM
__IO_EXTENDED CILCRSTR _cilcr;  
#define CILCR _cilcr.byte
#define CILCR_LVL0 _cilcr.bit._LVL0
#define CILCR_LVL1 _cilcr.bit._LVL1
#define CILCR_LVL2 _cilcr.bit._LVL2
#define CILCR_LVL3 _cilcr.bit._LVL3
#define CILCR_FCI _cilcr.bit._FCI
#define CILCR_EVAL_D5 _cilcr.bit._EVAL_D5
#define CILCR_EVAL_D6 _cilcr.bit._EVAL_D6
#define CILCR_EVAL_D7 _cilcr.bit._EVAL_D7
#define CILCR_LVL _cilcr.bitc._LVL
...
__IO_EXTENDED ADER3STR _ader3;  
#define ADER3 _ader3.byte
#define ADER3_ADE24 _ader3.bit._ADE24
#define ADER3_ADE25 _ader3.bit._ADE25
#define ADER3_ADE26 _ader3.bit._ADE26
#define ADER3_ADE27 _ader3.bit._ADE27
#define ADER3_ADE28 _ader3.bit._ADE28
#define ADER3_ADE29 _ader3.bit._ADE29
#define ADER3_ADE30 _ader3.bit._ADE30
#define ADER3_ADE31 _ader3.bit._ADE31
__IO_EXTENDED ADER4STR _ader4;  
#define ADER4 _ader4.byte
#define ADER4_ADE32 _ader4.bit._ADE32
#define ADER4_ADE33 _ader4.bit._ADE33
#define ADER4_ADE34 _ader4.bit._ADE34
#define ADER4_ADE35 _ader4.bit._ADE35
#define ADER4_ADE36 _ader4.bit._ADE36
#define ADER4_ADE37 _ader4.bit._ADE37
#define ADER4_ADE38 _ader4.bit._ADE38
#define ADER4_ADE39 _ader4.bit._ADE39
